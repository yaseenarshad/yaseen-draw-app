 ...
 * foreign script or fetch anyway, but not an image). Of these, only the stencils ship — the library
 * shapes load them on first use; the rest is bundled into the viewer or never used read-only.
 */
